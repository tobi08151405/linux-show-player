...
from lisp.plugins.gst_backend.elements.uri_video_input import UriVideoInput
from lisp.ui.settings.pages import SettingsPage
from lisp.ui.ui_utils import translate


class UriVideoInputSettings(SettingsPage):
    ELEMENT = UriVideoInput
    Name = ELEMENT.Name
    ...
    def retranslateUi(self):
        self.fileGroup.setTitle(translate("UriVideoInputSettings", "Source"))
        self.buttonFindFile.setText(translate("UriVideoInputSettings", "Find File"))
        self.bufferingGroup.setTitle(translate("UriVideoInputSettings", "Buffering"))
        self.useBuffering.setText(translate("UriVideoInputSettings", "Use Buffering"))
        self.download.setText(translate("UriVideoInputSettings", "Attempt download on network streams"))
        self.bufferSizeLabel.setText(translate("UriVideoInputSettings", "Buffer size (-1 default value)"))
    ...
    def select_file(self):
        ...
        path, _ = QFileDialog.getOpenFileName(
            self,
            translate("UriVideoInputSettings", "Choose file"),
            directory,
            translate("UriVideoInputSettings", "All files") + " (*)",
        )
